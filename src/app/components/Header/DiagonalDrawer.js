    ...
    <>
      <div className="relative">
        <div
          ...
          } cursor-pointer fixed w-14 h-14 lg:w-24 lg:h-24 bg-[#48afde] flex justify-center items-center rounded-br-3xl`}
        >
          <div>
            <div
      ...
      >
        <div className="relative">
          <div className="z-20 absolute transform-gpu ease-out duration-500 transition-all scale-100 -translate-x-none -translate-y-none opacity-100 bg-[#223740] bg-opacity-95 w-full h-screen flex flex-col sm:flex-row lg:flex=col items-center justify-center">
            <nav className="text-white font-rocoletaBold text-center text-4xl lg:text-4xl 2xl:text-6xl uppercase">
